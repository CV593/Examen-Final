...
$IPTABLES -A PREROUTING -t nat -p tcp --dport 22 -j DNAT --to 155.240.100.200:22
echo "reglas de puerto 22 ejecutadas correctamente"
$IPTABLES -A FORWARD -i enp0s3 -p tcp --dport 80 -j ACCEPT
$IPTABLES -A PREROUTING -t nat -p tcp --dport 80 -j DNAT --to 155.240.100.200:80
echo "reglas de puerto 80 ejecutadas correctamente"
$IPTABLES -A FORWARD -i enp0s3 -p tcp --dport 1898 -j ACCEPT
$IPTABLES -A PREROUTING -t nat -p tcp --dport 1898 -j DNAT --to 155.240.100.200:1898
